...
class Email {
    ...
    public function enviarConfirmacion() {
         ...
         $mail->setFrom('prueba@sorteo.com');
         ...
         $contenido = '<html>';
         $contenido .= "<p><strong>Hola " . $this->nombre .  "</strong> Has Registrado Correctamente tu cuenta en Sorteo; pero es necesario confirmarla</p>";
